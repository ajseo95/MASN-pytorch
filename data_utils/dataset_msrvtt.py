...
class MSRVTTQA(Dataset):
    ...
    def __init__(
        ...
        self.res_avg_file = os.path.join(self.feat_dir, "vfeat/msrvtt_res152_avgpool.hdf5")
        self.i3d_avg_file = os.path.join(self.feat_dir, "vfeat/msrvtt_i3d_avgpool_perclip.hdf5")

        self.res_avg_feat = None
        self.i3d_avg_feat = None

        self.res_roi_file = os.path.join(self.feat_dir, "vfeat/msrvtt_btup_f_obj10.hdf5")
        self.i3d_roi_file = os.path.join(self.feat_dir, "vfeat/msrvtt_i3d_roialign_perclip_obj10.hdf5")
    ...
    def create_answerset(self, ans_df):
        ...
        answer_freq = list(answer_freq.iloc[0:ans_num].keys())
        return answer_freq
