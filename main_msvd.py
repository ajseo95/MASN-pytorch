...
from data_utils.dataset_msvd import MSVDQA
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='[MSVD_msvd]')

    ################ path config ################
    parser.add_argument('--feat_dir', default='/data/MSVD-QA', help='path for imagenet and c3d features')
    parser.add_argument('--vc_dir', default='/data/MSVD-QA/vocab', help='path for vocabulary')
    parser.add_argument('--df_dir', default='/data/MSVD-QA/question', help='path for tgif question csv files')
