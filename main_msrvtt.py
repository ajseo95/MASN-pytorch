...
from data_utils.dataset_msrvtt import MSRVTTQA
...
def main():
    ...
    args.c3d_input_size = 2048

    args.text_embed_size = train_dataset.GLOVE_EMBEDDING_SIZE
    args.answer_vocab_size = None

    args.word_matrix = train_dataset.word_matrix
    ...
    args.answer_vocab_size = len(train_dataset.ans2idx)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='[MSVD_msrvtt]')

    ################ path config ################
    parser.add_argument('--feat_dir', default='/data/MSRVTT-QA/video', help='path for imagenet and c3d features')
    parser.add_argument('--vc_dir', default='/data/MSRVTT-QA/vocab4000', help='path for vocabulary')
    parser.add_argument('--df_dir', default='/data/MSRVTT-QA/question', help='path for tgif question csv files')
    ...
    parser.add_argument('--v_max_length', type=int, default=30)
